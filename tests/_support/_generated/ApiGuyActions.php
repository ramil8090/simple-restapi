<?php  //[STAMP] f5d1ec85d2f5ce6784832f7ddd8b8736
...
trait ApiGuyActions
{
     ...
     * @see \Helper\Api::seeJsonArrayWithCount()
     */
    public function canSeeJsonArrayWithCount($count) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeJsonArrayWithCount', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeJsonArrayWithCount($count) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeJsonArrayWithCount', func_get_args()));
    }
